...
public class BankCustomerResource {
    ...
    @Path("/{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public String getBankCustomerById(BankCustomer entity, @PathParam("id") int id) {
    ...
    public String getAllCustomers() {
        List<BankCustomer> bankCustomer = facade.getAllBankCustomers();
        return gson.toJson(bankCustomer);
    }
}
